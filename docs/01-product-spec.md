...
3. **Understanding over consumption.** Reading is rewarded, but _demonstrated
   understanding_ (quiz performance) is rewarded more.
...
comprehension of _what was just read_. Questions are generated alongside the content so

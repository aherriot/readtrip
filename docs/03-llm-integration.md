...
> the Anthropic SDK guidance is Opus 4.8; we deliberately route _down_ to Sonnet/Haiku
> for cost on this high-volume, kid-facing workload, and _up_ to Opus only where it pays
...
**The invariant:** caching is a _prefix match_. Keep stable content first, volatile
content last.
